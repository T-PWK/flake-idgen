...
(function () {
   ...
   * @param {Number} options.id - Generator identifier. It can have values from 0 to 511. It can be provided instead of <tt>datacenter</tt> and <tt>worker</tt> identifiers.
   * @param {Number} options.datacenter - Datacenter identifier. It can have values from 0 to 15.
